...
namespace CuMusicClub.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260923200335_AddYandexLoginToUser")]
    partial class AddYandexLoginToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CuMusicClub.Domain.Entities.CalendarEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CuMusicClub.Domain.Entities.CalendarFeed", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("calendar_feed", (string)null);
                });
            ...
            modelBuilder.Entity("CuMusicClub.Domain.Entities.RoadieTicket", b =>
                {
                    ...
                    b.Property<int>("RoadieTicketType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.ToTable("roadie_ticket", (string)null);
                });
            ...
            modelBuilder.Entity("CuMusicClub.Domain.Entities.SongRoadie", b =>
                {
                    b.Property<Guid>("SongId")
                        .HasColumnType("uuid")
                        .HasColumnName("song_id");
                    ...
                    b.ToTable("song_roadie", (string)null);
                });
            ...
            modelBuilder.Entity("CuMusicClub.Domain.Entities.RoadieTicket", b =>
                {
                    b.HasOne("CuMusicClub.Domain.Entities.ApplicationUser", "AcceptedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("CuMusicClub.Domain.Entities.SongRoadie", b =>
                {
                    b.HasOne("CuMusicClub.Domain.Entities.ApplicationUser", "Roadie")
                        .WithMany()
                        .HasForeignKey("RoadieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
