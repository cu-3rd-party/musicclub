...
class Role(Base):
    ...
    participations = relationship("SongParticipation", back_populates="role")
...
class SongParticipation(Base):
    ...
    def __repr__(self):
        return f"<SongParticipation(song={self.song.title}, person={self.person.name}, role={self.role.name})>"
