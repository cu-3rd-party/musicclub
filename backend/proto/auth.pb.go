...
const file_auth_proto_rawDesc = "" +
	...
	"\vpermissions\x18\x02 \x01(\v2$.musicclub.permissions.PermissionSetR\vpermissions2\xb5\x02\n" +
	"\vAuthService\x12L\n" +
	"\bRegister\x12#.musicclub.auth.RegisterUserRequest\x1a\x1b.musicclub.auth.AuthSession\x12D\n" +
...
var file_auth_proto_depIdxs = []int32{
	...
	2,  // 9: musicclub.auth.AuthService.Refresh:input_type -> musicclub.auth.RefreshRequest
	8,  // 10: musicclub.auth.AuthService.GetTgLoginLink:input_type -> musicclub.user.User
	10, // 11: musicclub.auth.AuthService.GetProfile:input_type -> google.protobuf.Empty
	6,  // 12: musicclub.auth.AuthService.Register:output_type -> musicclub.auth.AuthSession
	3,  // 13: musicclub.auth.AuthService.Refresh:output_type -> musicclub.auth.TokenPair
	4,  // 14: musicclub.auth.AuthService.GetTgLoginLink:output_type -> musicclub.auth.TgLoginLinkResponse
	7,  // 15: musicclub.auth.AuthService.GetProfile:output_type -> musicclub.auth.ProfileResponse
