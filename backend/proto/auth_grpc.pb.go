...
func (c *authServiceClient) Register(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*AuthSession, error) {
	out := new(AuthSession)
	err := c.cc.Invoke(ctx, "/musicclub.auth.AuthService/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) Login(ctx context.Context, in *Credentials, opts ...grpc.CallOption) (*AuthSession, error) {
	out := new(AuthSession)
	err := c.cc.Invoke(ctx, "/musicclub.auth.AuthService/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) Refresh(ctx context.Context, in *RefreshRequest, opts ...grpc.CallOption) (*TokenPair, error) {
	out := new(TokenPair)
	err := c.cc.Invoke(ctx, "/musicclub.auth.AuthService/Refresh", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetTgLoginLink(ctx context.Context, in *User, opts ...grpc.CallOption) (*TgLoginLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/musicclub.auth.AuthService/GetTgLoginLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetProfile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/musicclub.auth.AuthService/GetProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) TelegramWebAppAuth(ctx context.Context, in *TelegramWebAppAuthRequest, opts ...grpc.CallOption) (*AuthSession, error) {
	out := new(AuthSession)
	err := c.cc.Invoke(ctx, "/musicclub.auth.AuthService/TelegramWebAppAuth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) GetTgLoginLink(context.Context, *User) (*TgLoginLinkResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTgLoginLink not implemented")
}
...
func (UnimplementedAuthServiceServer) TelegramWebAppAuth(context.Context, *TelegramWebAppAuthRequest) (*AuthSession, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TelegramWebAppAuth not implemented")
}
...
func _AuthService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/musicclub.auth.AuthService/Register",
	}
...
func _AuthService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/musicclub.auth.AuthService/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_Refresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/musicclub.auth.AuthService/Refresh",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_GetTgLoginLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/musicclub.auth.AuthService/GetTgLoginLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_GetProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/musicclub.auth.AuthService/GetProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_TelegramWebAppAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/musicclub.auth.AuthService/TelegramWebAppAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
